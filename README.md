...
Cowork on a spatial canvas from the CLI — create canvases, generate images/text/video/agent responses, read results, recall past work, and manage nodes on [Flowith](https://beta.flowith.io)'s shared canvas.
